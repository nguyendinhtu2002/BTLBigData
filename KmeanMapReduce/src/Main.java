...
public class Main extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        String customerInputFolder = "/customer-input/";
        String customerInputFileName = "customer.csv";
        String inputFilePath = customerInputFolder + customerInputFileName;
        CallApi.fetchAndWriteDataToHDFS(conf, inputFilePath);
...
//		String inputFilePath = conf.get("in", null);
        ...
        int numLineOfInputFile = conf.getInt("lines", 2000);
        ...
        while (true) {
            ...
            if (needStop) {
                ...
                if (nLoop > 1) {
                    Path outputPath = new Path("/customer-output-points");
                    FileSystem hdfs = FileSystem.get(conf);
        ...
        if (newCentroidPoints != null) {
            ...
            CallApi.saveCentroidsToMongoDB(newCentroidPoints);
        }
        System.out.println("----------------------------------------------");
